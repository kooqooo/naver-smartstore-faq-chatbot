...
from src.config import CHAT_MODEL, chat_system_prompt_path
from src.config import client as chat_client
...
async def chat_endpoint(request: ChatRequest):
    ...
    messages_with_reference = system_prompt_messages.render_all(
    ...
    async def generate():
        response = chat_client.chat.completions.create(
            model=CHAT_MODEL, messages=messages_with_reference.to_dict(), stream=True
        )
